...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   escape_menu_main_menu.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: reclaire <reclaire@student.42mulhouse.f    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/16 03:05:01 by reclaire          #+#    #+#             */
/*   Updated: 2023/01/30 15:43:54 by reclaire         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "escape_menu.h"

static void	escape_menu_main_menu_release(t_game *g, t_ui *ui)
{
	(void)g;
	(void)ui;
	switch_escape_menu();
...
void	escape_menu_main_menu(void)
{
	...
	ui = mlxe_create_ui(g_esc_menu.root, "escape menu main menu");
	img = mlxe_render_text(g_game, g_settings.font,
			"Main menu", new_color(255, 255, 255, 255));
	ui->pos = v2(0.01, 0.9);
	...
	ui->on_release = escape_menu_main_menu_release;
	g_esc_menu.main_menu_button = ui;
